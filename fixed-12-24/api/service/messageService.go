...
func SendGetCDNDnsService(queryKey string) vo.DTO {
	return checkExIdPerformNoCreateConnect(queryKey, func(wxAccount wxface.IWXAccount, newIWXConnect bool) vo.DTO {
		...
		resp, err := reqInvoker.SendGetCDNDnsRequest()
		if err != nil {
			return vo.NewFail("SendGetCDNDnsService err:" + err.Error())
		}
...
func NewSyncHistoryMessageService(queryKey string, m model.SyncModel) vo.DTO {
	return checkExIdPerformNoCreateConnect(queryKey, func(wxAccount wxface.IWXAccount, newIWXConnect bool) vo.DTO {
		...
		NewSyncResponse, err := bizcgi.NewSyncHistoryMessageRequest(wxAccount, m.Scene, m.SyncKey)
		if err != nil {
